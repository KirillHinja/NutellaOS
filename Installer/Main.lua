...
local repositoryURL = "https://raw.githubusercontent.com/KirillHinja/NutellaOS/master/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "Грузим систему на EEPROM :)")
...
local installerMenu = menu:addContextMenuItem("Nutella OS", 0x2D2D2D)
